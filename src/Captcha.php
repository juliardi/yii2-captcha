 ...
 *
 * You may use [[\juliardi\captcha\CaptchaValidator]] to validate the user input matches
...
class Captcha extends InputWidget
{
    ...
    public function registerClientScript()
    {
        ...
        $view->registerJs("jQuery('#$id').juliardiCaptcha($options);");
    }
    ...
    protected function getClientOptions()
    {
        ...
        $options = [
            ...
            'hashKey' => 'juliardiCaptcha/' . trim($route[0], '/'),
        ];
